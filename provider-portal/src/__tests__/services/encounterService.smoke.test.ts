...
describe('EncounterService - Smoke Tests', () => {
  ...
  describe('Prescription APIs', () => {
    ...
    it('should fetch prescriptions by encounter', async () => {
      ...
      const result = await encounterService.getPrescriptionsByEncounter('enc-456');
    ...
    it('should check prescription interactions', async () => {
      ...
      const result = await encounterService.checkPrescriptionInteractions('rx-123', [
        { genericName: 'Ibuprofen' },
      ]);
  ...
  describe('Investigation APIs', () => {
    ...
    it('should fetch investigations by encounter', async () => {
      ...
      const result = await encounterService.getInvestigationsByEncounter('enc-456');
    ...
    it('should search investigations by LOINC code', async () => {
      ...
      const result = await encounterService.searchInvestigationByLoinc('2345-7');
  ...
  describe('Medication APIs', () => {
    ...
    it('should get medication contraindications', async () => {
      ...
      const result = await encounterService.getMedicationContraindications('7682');
    ...
    it('should check medication allergies', async () => {
      ...
      const result = await encounterService.checkMedicationAllergies('pat-123', ['Aspirin']);
  ...
  describe('Error Handling', () => {
    ...
    it('should handle medication search errors', async () => {
      ...
      await expect(encounterService.searchMedications('aspirin')).rejects.toThrow();
    });
  });
});
