...
type WorkflowItemType = 'RADIOLOGY';
...
export class WorkflowIntegrationService {
  ...
  async notify(update: WorkflowItemStatusUpdate): Promise<void> {
    ...
    const payload = {
      ...
      itemType: 'RADIOLOGY' as WorkflowItemType,
    ...
    try {
      ...
      this.logger.error(
        'Failed to notify workflow service of radiology order update',
        error as Error,
      );
    }
  }
